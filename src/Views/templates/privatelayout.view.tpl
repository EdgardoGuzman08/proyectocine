...
<body>
  ...
  <div class="Header">
    <div class="Logo">
      <a href="index.php?page=mnt-index">CineMagico</a>
    </div>        
      
    <div class="BarraBusqueda">      
      <input type="text" placeholder="Busque sus peliculas" onfocus="this.placeholder=''"
        onblur="this.placeholder='Busque sus peliculas'" id="txtSearch" autocomplete="off">
      <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" onclick="SearchCine()">
    ...
    <div class="MSJ">      
      ...
      <svg xmlns="http://www.w3.org/2000/svg" onclick="MisCines()" id="SvgBooks" height="24" width="24">
    ...
    <div class="Enlaces">      
      <nav id="menu">
        <ul>
          ...
          <li><a href="index.php?page=mnt-agregars"><i class="fas fa-sign-out-alt"></i>&nbsp;Listar Peliculas</a></li>
